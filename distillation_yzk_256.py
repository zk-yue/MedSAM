...
class NpyDataset(Dataset):
    ...
    # def __init__(self, data_root, image_size=256,  data_aug=False):
...
for epoch in range(start_epoch , num_epochs):
    ...
    for step, batch in enumerate(pbar):
        ...
        with torch.no_grad():
            ...
            # image_teacher = transform(image)
            # teacher_output = medsam_model.image_encoder(image_teacher)
        ...
        image_student = transform(image)
        output=student_model(image_student)
